...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                '/argus.inference.v1.InferenceService/Predict',
        ...
        self.Health = channel.unary_unary(
                '/argus.inference.v1.InferenceService/Health',
...
def add_InferenceServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'argus.inference.v1.InferenceService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('argus.inference.v1.InferenceService', rpc_method_handlers)
